...
class Laporan_produk extends BaseControllerBackend {
    ...
    function data_pemesanan(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/laporan_produk/data_pemesanan/body",$this->global,NULL,"backend/admin/laporan_produk/data_pemesanan/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_pemesanan(){
        ...
        $this->load->view('backend/admin/laporan_produk/data_pemesanan/load_laporan', $data);
    }
   ...
   function data_masuk(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/laporan_produk/data_masuk/body",$this->global,NULL,"backend/admin/laporan_produk/data_masuk/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_masuk(){
        ...
        $this->load->view('backend/admin/laporan_produk/data_masuk/load_laporan', $data);
    }
    ...
    function data_keluar(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/laporan_produk/data_keluar/body",$this->global,NULL,"backend/admin/laporan_produk/data_keluar/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_keluar(){
        ...
        $this->load->view('backend/admin/laporan_produk/data_keluar/load_laporan', $data);
    }
    ...
    function data_penyesuaian_stok(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/laporan_produk/data_penyesuaian_stok/body",$this->global,NULL,"backend/admin/laporan_produk/data_penyesuaian_stok/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_penyesuaian_stok(){
        ...
        $this->load->view('backend/admin/laporan_produk/data_penyesuaian_stok/load_laporan', $data);
    }
    ...
    function data_retur(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/laporan_produk/data_retur/body",$this->global,NULL,"backend/admin/laporan_produk/data_retur/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_retur(){
        ...
        $this->load->view('backend/admin/laporan_produk/data_retur/load_laporan', $data);
    }
}
