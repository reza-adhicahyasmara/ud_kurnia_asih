...
class bahan_baku_masuk extends BaseControllerBackend {
    ...
    function index(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Admin'){
            ...
            $this->loadViews("backend/admin/bahan_baku_masuk/body",$this->global,$data,"backend/admin/bahan_baku_masuk/footer");
        }  
        else{ 
            redirect('login');
        }
    ...
    function load_data_bahan_baku_masuk(){
        ...
        $this->load->view('backend/admin/bahan_baku_masuk/load_bahan_baku_masuk', $data);
    }
