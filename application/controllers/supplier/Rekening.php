...
class Rekening extends BaseControllerBackend {
    ...
    function index(){
        ...
        if($id_supplier != null && $hak_akses == 'Supplier'){
            ...
            $this->loadViews("backend/supplier/rekening/body",$this->global,NULL,"backend/supplier/rekening/footer");
        }  
        else{ 
            redirect('login');
        }  
    ...
    function load_data_rekening(){
        ...
        $this->load->view('backend/supplier/rekening/load_rekening', $data);
    }

    function form_tambah_rekening(){
        $data['bank'] = $this->Mod_bank->get_all_bank();
        $this->load->view("backend/supplier/rekening/form_tambah_rekening", $data);
    }
    ...
    function form_edit_rekening(){
        ...
        $this->load->view("backend/supplier/rekening/form_edit_rekening", $data);
    }
