...
class Bahan_baku extends BaseControllerBackend {
    ...
    function index() {
        ...
        if($nik_karyawan != null && $hak_akses == 'Gudang'){
            ...
            $this->loadViews("backend/gudang/bahan_baku/body",$this->global,NULL,"backend/gudang/bahan_baku/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function load_data_bahan_baku(){
        ...
        $this->load->view('backend/gudang/bahan_baku/load_bahan_baku', $data);
    }
