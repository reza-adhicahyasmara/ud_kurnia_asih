...
class Customer extends BaseControllerBackend {
    ...
    function index() {
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/customer/body",$this->global,NULL,"backend/pimpinan/customer/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function load_data_customer(){
        ...
        $this->load->view('backend/pimpinan/customer/load_customer', $data);
    }
