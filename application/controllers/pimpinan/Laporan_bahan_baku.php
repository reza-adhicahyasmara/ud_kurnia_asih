...
class Laporan_bahan_baku extends BaseControllerBackend {
    ...
    function data_pemesanan(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/laporan_bahan_baku/data_pemesanan/body",$this->global,NULL,"backend/pimpinan/laporan_bahan_baku/data_pemesanan/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_pemesanan(){
        ...
        $this->load->view('backend/pimpinan/laporan_bahan_baku/data_pemesanan/load_laporan', $data);
    }
    ...
    function data_masuk(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/laporan_bahan_baku/data_masuk/body",$this->global,NULL,"backend/pimpinan/laporan_bahan_baku/data_masuk/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_masuk(){
        ...
        $this->load->view('backend/pimpinan/laporan_bahan_baku/data_masuk/load_laporan', $data);
    }
    ...
    function data_keluar(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/laporan_bahan_baku/data_keluar/body",$this->global,NULL,"backend/pimpinan/laporan_bahan_baku/data_keluar/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_keluar(){
        ...
        $this->load->view('backend/pimpinan/laporan_bahan_baku/data_keluar/load_laporan', $data);
    }
    ...
    function data_penyesuaian_stok(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/laporan_bahan_baku/data_penyesuaian_stok/body",$this->global,NULL,"backend/pimpinan/laporan_bahan_baku/data_penyesuaian_stok/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_penyesuaian_stok(){
        ...
        $this->load->view('backend/pimpinan/laporan_bahan_baku/data_penyesuaian_stok/load_laporan', $data);
    }
    ...
    function data_retur(){
        ...
        if($nik_karyawan != null && $hak_akses == 'Pimpinan'){
            ...
            $this->loadViews("backend/pimpinan/laporan_bahan_baku/data_retur/body",$this->global,NULL,"backend/pimpinan/laporan_bahan_baku/data_retur/footer");
        }
        else{ 
            redirect('login');
        }  
    ...
    function laporan_data_retur(){
        ...
        $this->load->view('backend/pimpinan/laporan_bahan_baku/data_retur/load_laporan', $data);
    }
}
