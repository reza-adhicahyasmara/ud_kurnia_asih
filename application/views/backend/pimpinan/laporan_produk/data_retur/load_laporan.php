...
<caption></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="<?php echo $baris;?>" class="text-sm" style="text-align: left; vertical-align: middle;"><a href="<?php echo base_url('pimpinan/retur_produk/detail/').$row->kode_retur_produk;?>"><?php echo $row->kode_retur_produk;?></a></td>
