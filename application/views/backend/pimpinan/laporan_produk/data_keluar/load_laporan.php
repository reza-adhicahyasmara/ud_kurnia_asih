...
<caption></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="<?php echo $baris;?>" class="text-sm" style="text-align: left; vertical-align: middle;"><a href="<?php echo base_url('pimpinan/pemesanan_bahan_baku/detail/').$row->kode_pemesanan_produk;?>"><?php echo $row->kode_pemesanan_produk;?></a></td>
            <?php
                foreach($item_produk->result() as $row1) {   
                    if($row1->kode_pemesanan_produk == $row->kode_pemesanan_produk){?>
        </tr>
