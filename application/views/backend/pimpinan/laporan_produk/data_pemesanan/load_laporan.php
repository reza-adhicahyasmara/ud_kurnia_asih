...
<caption></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-sm" style="text-align: left; vertical-align: middle;"><a href="<?php echo base_url('pimpinan/pemesanan_produk/detail/').$row->kode_pemesanan_produk;?>"><?php echo $row->kode_pemesanan_produk;?></a></td>
