...
<script type="text/javascript">
    var url_supplier =  "<?php echo base_url('pimpinan/supplier'); ?>";
...
<script type="text/javascript">
	...
	function load_data_supplier(){
		$.ajax({
			method : "GET",
			url : '<?php echo base_url('pimpinan/supplier/load_data_supplier'); ?>',
			beforeSend : function(){
...
<script type="text/javascript">
    ...
    function load_data_bahan_baku(){
		...
		$.ajax({
			method : "POST",
			url : '<?php echo base_url('pimpinan/supplier/load_data_bahan_baku');?>',
