...
<script type="text/javascript">
    var url_outlet =  "<?php echo base_url('admin/pemesanan_produk'); ?>";
    var url = url_outlet ;
...
<script type="text/javascript">
    ...
    function load_data_item_pemesanan_produk(){
        ...
        $.ajax({
            method : "POST",
            url : '<?php echo base_url('admin/pemesanan_produk/load_data_item_pemesanan_produk');?>',
            data : {
...
<script>
    ...
    var url_global = '<?php echo base_url('admin/pemesanan_produk/update_pemesanan_produk'); ?>';
