 <div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-1 text-dark"><span class="nav-icon bx bx-fw bxl-dropbox"></span>Data Produk</h1>
                </div>
            ...
            <div class="card card-secondary card-outline card-outline-tabs">
                <div class="card-body">
                    <div class="float-right">
                        <button type="button" class="btn bg-purple" id="btn_tambah_produk"><span class="bx bx-fw bx-plus"></span> Tambah Data </a>
                    </div>
                    <br>
                    <br>
                    <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btn_simpan_produk" class="btn bg-purple"><span class="bx bx-fw bx-save"></span> Simpan</button>
                </div>
            </div>
        </div>
    </div>
