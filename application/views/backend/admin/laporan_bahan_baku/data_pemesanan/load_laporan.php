...
<caption></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-sm" style="text-align: left; vertical-align: middle;"><a href="<?php echo base_url('admin/pemesanan_bahan_baku/detail/').$row->kode_pemesanan_bb;?>"><?php echo $row->kode_pemesanan_bb;?></a></td>
