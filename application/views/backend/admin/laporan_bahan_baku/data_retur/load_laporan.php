...
<caption></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="<?php echo $baris;?>" class="text-sm" style="text-align: left; vertical-align: middle;"><a href="<?php echo base_url('admin/retur_bahan_baku/detail/').$row->kode_retur_bb;?>"><?php echo $row->kode_retur_bb;?></a></td>
