                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 float-sm-right">
                        <ol class="breadcrumb float-sm-right m-2">
                            ...
                            <span class="breadcrumb-item"><a href="<?php echo base_url('admin/retur_produk'); ?>">Data Retur Produk</a></span>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="float-sm-right breadcrumb ">
                            ...
                            <?php } ?>
                            <div class="form-group">
                                <a href="<?php echo base_url('admin/retur_produk/invoice/').$haha->kode_retur_produk;?>"target="_blank" class="btn btn-warning" style="margin-left: 5px;"><span class="bx bx-fw bx-printer"></span> Print</a>
                            </div>
                        </div>
                    </div>
                </div>
