<table style="width:100%" id="dataTablePenyesuaianStokBB" class="table table-bordered table-striped">
    ...
    <thead>
        <tr>
            ...
            <th id="" style="text-align: center; vertical-align: middle; width:20%">Nama Bahan Baku</th>
    ...
    <tbody>
        <?php 
            $no = 1;
            foreach($penyesuaian_bb->result() as $row) {
        ?>
        <tr>
            <td style="text-align: center; vertical-align: middle;"><?php echo $no;?></td>
            <td style="text-align: center; vertical-align: middle;">
                <?php if($row->gambar_penyesuaian_bb != "") { ?>
                    <div class="d-flex justify-content-center">
                        <div class=" img-circle elevation-1" style="width: 80px; height: 80px; border:1px solid #ced4da;">
                            <img src="<?php echo base_url('assets/img/bahan_baku/'.$row->gambar_penyesuaian_bb);?>" alt="Image" class="img-circle elevation-1" style="width:80px; height:80px; object-fit:cover; background:white;">
                        </div>
                    </div>
                <?php }else{ ?>
                    <div class="d-flex justify-content-center">
            ...
            <td style="text-align: left; vertical-align: middle;"><?php echo $row->tanggal_penyesuaian_bb;?></td>
            <td style="text-align: left; vertical-align: middle;"><?php echo $row->nama_bb;?></td>
            <td style="text-align: right; vertical-align: middle;"><?php echo number_format($row->jumlah_penyesuaian_bb,2,",",".")." ".$row->nama_satuan;?></td>
            <td style="text-align: left; vertical-align: middle;"><?php echo $row->keterangan_penyesuaian_bb;?></td>
            <td style="text-align: center; vertical-align: middle;" >
                <a class='btn btn-danger btn-sm btn-rounded btn_hapus_penyesuaian_bb'
                    kode_penyesuaian_bb="<?php echo $row->kode_penyesuaian_bb; ?>" 
                    nama_bb="<?php echo $row->nama_bb; ?>" 
                    jumlah_penyesuaian_bb="<?php echo $row->jumlah_penyesuaian_bb; ?>"
