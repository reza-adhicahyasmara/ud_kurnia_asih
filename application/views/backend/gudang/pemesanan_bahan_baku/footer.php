...
<script type="text/javascript">
    var url_outlet =  "<?php echo base_url('gudang/pemesanan_bahan_baku'); ?>";
    var url = url_outlet ;
...
<script type="text/javascript">
    ...
    function load_data_item_pemesanan_bb(){
        ...
        $.ajax({
            method : "POST",
            url : '<?php echo base_url('gudang/pemesanan_bahan_baku/load_data_item_pemesanan_bb');?>',
            data : {
...
<script>
    $('.btn_terima').on("click",function(){
        var kode_pemesanan_bb = $(this).attr("kode_pemesanan_bb");
        var status_pemesanan_bb = "5";
        ...
        Swal.fire({
            ...
            preConfirm: (response) => {       
                $.ajax({
                    url: '<?php echo base_url('gudang/pemesanan_bahan_baku/update_status_pemesanan_bb'); ?>',
                    method: 'POST',
                    data: {
                        kode_pemesanan_bb:kode_pemesanan_bb,
                        status_pemesanan_bb:status_pemesanan_bb
