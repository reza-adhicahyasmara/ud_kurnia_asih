                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 float-sm-right">
                        <ol class="breadcrumb float-sm-right m-2">
                            ...
                            <span class="breadcrumb-item"><a href="<?php echo base_url('gudang/retur_bahan_baku'); ?>">Data Retur Bahan Baku</a></span>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="float-sm-right breadcrumb ">
                            <?php if($status_retur_bb == 2){ ?>
                                <div class="form-group">
                                    <button class="btn btn-success" id="btn_retur_diterima" kode_retur_bb = <?php echo $haha->kode_retur_bb; ?> style="width:200px; margin-left: 5px;"><i class="bx bx-fw bx-check"></i> Retur Diterima </button> 
                                </div>
                            <?php } ?>
                            <div class="form-group">
                                <a href="<?php echo base_url('gudang/retur_bahan_baku/invoice/').$haha->kode_retur_bb;?>"target="_blank" class="btn btn-warning" style="margin-left: 5px;"><span class="bx bx-fw bx-printer"></span> Print</a>
                            </div>
                        </div>
                    </div>
                </div>
