...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><span class="nav-icon bx bx-fw bx-lock"></span>Ubah Password</h1>
                </div>
                    ...
                    <div class="card card-outline">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="nik_karyawan" id="nik_karyawan" value="<?php echo $edit->nik_karyawan; ?>" placeholder="NIK" readonly>
