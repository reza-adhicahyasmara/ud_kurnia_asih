    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;" >
                ...
                <a class='btn btn-danger btn-sm btn-rounded btn_hapus_proposal' judul_proposal="<?php echo $row->judul_proposal; ?>" kode_proposal="<?php echo $row->kode_proposal; ?>" berkas_proposal="<?php echo $row->berkas_proposal; ?>"><span class="bx bx-fw bx-trash"></span></a>
            </td>
        </tr>
        <?php
                    $no++;
