            ...
            <div class="card card-purple card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-tabs-four-proposal-tab" data-toggle="pill" href="#custom-tabs-four-proposal" role="tab" aria-controls="custom-tabs-four-proposal" aria-selected="true">Permintaan Pabrik<?php if($proposal != 0){ ?><span class="badge badge-danger right"> <?php echo $proposal; ?></span><?php } ?><a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-four-permintaan-tab" data-toggle="pill" href="#custom-tabs-four-permintaan" role="tab" aria-controls="custom-tabs-four-permintaan" aria-selected="false">Penawaran Supplier</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-four-tabContent">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-four-permintaan" role="tabpanel" aria-labelledby="custom-tabs-four-permintaan-tab">
                            <div class="mb-3 float-right">
                                <button type="button" class="btn bg-purple" id="btn_tambah_proposal"><span class="bx bx-fw bx-plus"></span> Tambah Data </a>
                            </div>
                            <br>
                            <br>
                            <br>
