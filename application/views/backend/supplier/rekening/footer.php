...
<script type="text/javascript">
    var url_rekening =  "<?php echo base_url('supplier/rekening'); ?>";
...
<script type="text/javascript">
	...
	function load_data_rekening(){
		$.ajax({
			method : "GET",
			url : '<?php echo base_url('supplier/rekening/load_data_rekening'); ?>',
			beforeSend : function(){
    ...
    $('#btn_tambah_rekening').on("click",function(){
        var url = "<?php echo base_url('supplier/rekening/form_tambah_rekening'); ?>";
    ...
    $(document).on('click', '.btn_edit_rekening', function(e) {
        ...
        var url = "<?php echo base_url('supplier/rekening/form_edit_rekening'); ?>";
        ...
        $('#btn_simpan_rekening').on("click",function(){
            $('#form_rekening').validate({
                ...
                submitHandler: function() {
                    ...
                    if (jenis == "Tambah"){
                        $.ajax({
                            url : '<?php echo base_url('supplier/rekening/tambah_rekening'); ?>',
                            method: 'POST',
                        ...
                        $.ajax({
                            url : '<?php echo base_url('supplier/rekening/edit_rekening'); ?>',
                            method: 'POST',
                            data: $('#form_rekening').serialize(),
                            success: function(response){
                                if(response==1){
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        url: '<?php echo base_url('supplier/rekening/hapus_rekening'); ?>',
                        method: 'POST',
